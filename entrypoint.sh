...
DOCUMENTS_DIR=${'INPUT_DOCUMENTS-DIR':-documents}
IMAGES_DIR=${'INPUT_IMAGES-DIR':-images}
ARTIFACTS_DIR=${'INPUT_ARTIFACTS-DIR':-artifacts}
PUSH_TO_REPOSITORY=${I'NPUT_PUSH-TO-REPOSITORY':-false}
UNIFIED_PDF=${'INPUT_UNIFIED-PDF':-true}
INCLUDE_DATE=${'INPUT_INCLUDE-DATE':-true}
SAVE_VERSION=${'INPUT_SAVE-VERSION':-true}
BASE_FILE_NAME=${'INPUT_BASE-FILE-NAME':-$(basename "${GITHUB_REPOSITORY}")}
TEMPLATE_TEX=${'INPUT_TEMPLATE-TEX':-default_template}
